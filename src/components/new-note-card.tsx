...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    function handleSaveNote(event: FormEvent) {
        ...
        if (content !== '') {
            ...
            toast.error('Não foi possível criar a nota! Digite algo!')
            setContent('')
            setShouldShowOnboarding(true)
        }
                    ...
                    <form className="flex-1 flex flex-col">
                        ...
                        <div className="flex flex-1 flex-col gap-3 p-5">
                            ...
                            {shouldShowOnboarding ? (
                                <p className="text-sm leading-6 text-slate-400">
                                    Comece <button type='button' className="font-medium text-lime-400 hover:underline" onClick={handleStartRecord}>gravando uma nota</button> em áudio ou se preferir <button type='button' className="font-medium text-lime-400 hover:underline" onClick={handleStartEditor}>utilize apenas texto</button>.
                                </p>
                            ) : (
                                <textarea
                                    autoFocus
                        ...
                        {isRecording ? (<button type="button"
                        ...
                        >
                            <div className="size-3 rounded-md bg-red-500 animate-pulse" />
