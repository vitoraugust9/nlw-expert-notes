...
export function App() {
  ...
  return (
    <div className="flex flex-col min-h-[98vh] mx-auto max-w-6xl space-y-6 px-5 flex-grow font-sans">
      <div className="mx-auto max-w-6xl my-10 space-y-6 px-5 flex-grow">
